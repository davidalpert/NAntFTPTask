...
// - changed internal keyword to public so it does not conflict with the ConsolePasswordInput class's promotion to public.
public struct COORD
{
	internal short X;
	internal short Y;
...
namespace ConsolePasswordInput
{
	...
	/// <remarks>Change log:
	/// <list type="unordered">
	/// <item>Monday, December 20, 2004<br />David Alpert (david@spinthemoose.com)</item>
	/// <description>Added a public keyword so that this class is available externally from a library.</description>
	/// </list>
	/// </remarks>
...
// commented out by David Alpert (david@spinthemoose.com) on Monday, December 20, 2004 to build as a library
//		/// <summary>
