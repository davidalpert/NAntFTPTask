...
{    
	...
	public class FTPFile
	{
		...
		/// <summary>A publicly accessible constructor for use in emergency situations...</summary>
		/// <remarks>Added by David Alpert <david@spinthemoose.com> on Dec.22.04 as an adaptation 
		///          to support the RemotePath class in the NAnt FTP Task.</remarks>
		public FTPFile(int type, string name, bool isDir) {
			this.type = type;
