...
{
	/// <summary>  
	/// Test general methods such as System()
	/// </summary>
	/// <author>  
    /// Bruce Blackshaw        
	/// </author>
	...
	[TestFixture]
    [Category("edtFTPnet")]
	public class TestGeneral:FTPTestCase
	{
		/// <summary>  
		...
		/// <summary>  Test some general methods</summary>
		[Test]
		public virtual void GetSystem()
		{
			Connect();
			Login();
			
			// system
			log.Debug("SYST=" + ftp.GetSystem());
